...
export const Carousel: React.FC = () => {
  ...
  return (
    <div className="relative h-[600px] overflow-hidden rounded-3xl bg-gradient-to-r from-blue-50 via-white to-blue-50"> {/* Increased height to accommodate larger images */}
      {/* Navigation Arrows */}
      <button 
        onClick={prevSlide}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-12">
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="mt-8 bg-blue-600 text-white px-8 py-4 rounded-xl w-fit
            ...
            {/* Image Section - Updated dimensions */}
            <div className="relative flex items-center justify-center h-[600px]"> {/* Increased height */}
              <div className="relative w-[500px] h-[500px]"> {/* Increased width and height */}
